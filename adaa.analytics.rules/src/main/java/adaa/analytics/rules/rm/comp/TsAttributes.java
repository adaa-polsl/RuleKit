...
import adaa.analytics.rules.rm.example.AttributeIterator;
...
public class TsAttributes implements IAttributes {

    protected DataTable dataTable;

    public TsAttributes(DataTable dataTable) {
    ...
    public boolean contains(IAttribute var1) {
        return dataTable.getColumn(var1.getName()).equals(var1.getColumnMetaData());
    }
    ...
    public IAttribute get(String name, boolean caseSensitive) {
        ...
        if(caseSensitive) {
            ...
            return cmd == null ? null : new TsAttribute(cmd);
        }
    ...
    public IAttribute getRegular(String name) {
        ...
        if(colMetaData.getRole() == EColumnRole.regular.name()) {
            return new TsAttribute(colMetaData);
        }
    ...
    public IAttribute getSpecial(String role) {
        ...
        return new TsAttribute(cols.get(0));
    }
