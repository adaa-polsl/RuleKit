...
public class IntersectionFinder {
	...
	public List<Interval> calculateAllIntersectionsOf(List<Interval> intervals) {
		...
		Interval rightmost = intervals.stream().max(Comparator.comparing(Interval::getRight)).map(Interval.class::cast).orElseThrow(() -> new RuntimeException("Empty interval list"));
